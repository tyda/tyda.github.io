...
{	var Instance1 = new ImageFlow();
	Instance1.init({ ImageFlowID:'Instance_1',
		...
		reflections:false, 
		xStep: 150  ,                      /* 圖片x軸間距 */
		reflectionP:0.4,                   /* 圖片高度縮放比例 */
		opacity:true,                      /* 透明效果 */
		opacityArray: [10,6,3,1] ,         /* 透明效果值從　0~10 */
		startID:5,                         /* 起始顯示照片的ID */
		startAnimation:true,               /* 起始動畫效果 */
		preloadImagesText: '圖片載入中...' ,/*圖片載入的提示文字*/
		imageFocusM:1.2 }); /* 圖片的顯示比例 */
	...
	Instance2.init({ ImageFlowID:'Instance_2',
		reflections: false, 
        reflectionP: 0.0, /* 圖片高度縮放比例 */
		opacity:true,                      /* 透明效果 */
		opacityArray: [10,9,8,8,7,7] ,         /* 透明效果值從　0~10 */
		imageFocusMax: 8,/* 二邊照片出現的張數 */
        slider: false,/* 顯示捲軸 */
		startID: 1, });/* 起始顯示照片的ID */
	...
	Instance3.init({ ImageFlowID: 'Instance_3',
         captions:false,                    /* 標題顯示 */ 
         imageScaling: false, /* 影像縮放切換 */ 
         reflections: false, 
		 buttons: true,                    /* 上下張的按鈕圖示*/
		 slider: false,/* 顯示捲軸 */
         xStep: 90, /* 圖片x軸間距 */
         imageFocusMax: 5 });/* 二邊照片出現的張數 */
